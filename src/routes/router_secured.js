...
router_secured.post('/clients/get', clientController.getClients)
...
router_secured.post('/announcements/search', announcementsController.searchAnnouncements)
router_secured.post('/announcements/getbyuser/:id', announcementsController.getAnnouncementsByUserId)
...
router_secured.put('/password/update/:id', passwordController.updatePasswordLocal)
